...
public class DlgDokter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-07-2022" }));
        ...
        FormPhoto.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "Scan Tandatangan Dokter: ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
  ...
  isForm();                
    ...
    private void ChkAccorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkAccorActionPerformed
        if(tbDokter.getSelectedRow()!= -1){
            ...
            ChkAccor.setSelected(false);
            JOptionPane.showMessageDialog(null,"Silahkan pilih Dokter...!!!");
        }
    ...
    private void btnAmbilPhotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilPhotoActionPerformed
        if(tbDokter.getSelectedRow()!= -1){
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            System.out.println(""+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().replaceAll(" ","_"));
            Valid.panggilUrl("tandatangandokter/login.php?act=login&usere=admin&passwordte=akusayangsamakamu&kd_dokter="+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().replaceAll(" ","_"));
            this.setCursor(Cursor.getDefaultCursor());
        }
...
//            NoRekamMedisDipilih.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString());
//            NamaPasienDipilih.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString());
    ...
    private void panggilPhoto() {
        if(FormPhoto.isVisible()==true){
            try {
                ps=koneksi.prepareStatement("select tandatangandokter.photo from tandatangandokter where tandatangandokter.kd_dokter=?");
                try {
                    ...
                    if(rs.next()){
                        if(rs.getString("photo").equals("")||rs.getString("photo").equals("-")){
                            ...
                            LoadHTML.setText("<html><body><center><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/tandatangandokter/"+rs.getString("photo")+"' alt='photo' width='"+(internalFrame1.getWidth()-330)+"' height='"+(internalFrame1.getHeight()-260)+"'/></center></body></html>");
                        }  
                    }else{
                        LoadHTML.setText("<html><body><center><br><br><font face='tahoma' size='2' color='#434343'>Kosong</font></center></body></html>");
                    }
